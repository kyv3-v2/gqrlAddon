package meteordevelopment.addons.template.modules.hud.visual;
...
public class Logo extends HudElement {
    private static final Identifier LOGO = new Identifier("gqrladdon", "logo.png");
    private static final Identifier LOGO_FLAT = new Identifier("gqrladdon", "logo_flat.png");
    ...
    public Logo(HUD hud) {
        super(hud, "logo", "Displays the logo.");
    }
